...
global.log = function (severity, system, text, data) {
  ...
  if (logConsole) {
    if (config.logging.console.colors) { console.log(severityMap[severity](time) + clc.white.bold(' [' + system + '] ') + formattedMessage) } else { console.log(time + ' [' + system + '] ' + formattedMessage) }
  }
